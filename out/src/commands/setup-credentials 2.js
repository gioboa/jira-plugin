...
class SetupCredentialsCommand {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            const baseUrl = configuration_1.getConfigurationByKey(configuration_1.CONFIG.URL);
            if (baseUrl) {
            ...
            configuration_1.setConfigurationByKey(configuration_1.CONFIG.URL, yield vscode.window.showInputBox({ ignoreFocusOut: true, password: false, placeHolder: 'Your JIRA url' }));
...
//# sourceMappingURL=setup-credentials 2.js.map